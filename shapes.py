...
class point():
    ...
    def draw(self,drawNc=False):
        draw_point(self.char,self.x1,self.y1, self.output,self.baseColor,self.palette, drawNc)
...
class line():
    def __init__(self,char,x1,y1,x2,y2, output=object,baseColor=None,palette=DrawlibStdPalette, autoDraw=False,autoDrawNc=False):
        ...
        if autoDraw == True: self.draw(autoDrawNc)
    def draw(self,drawNc=False):
        draw_line(self.char,self.x1,self.y1,self.x2,self.y2, self.output,self.baseColor,self.palette, drawNc)
...
class triangle():
    def __init__(self,char,x1,y1,x2,y2,x3,y3, output=object,baseColor=None,palette=DrawlibStdPalette, autoDraw=False,autoDrawNc=False):
        ...
        if autoDraw == True: self.draw(autoDrawNc)
    def draw(self,drawNc=False):
        draw_triangle_coords(self.char,self.x1,self.y1,self.x2,self.y2,self.x3,self.y3, self.output,self.baseColor,self.palette, drawNc)
...
class rectangle():
    ...
    def draw(self,drawNc=False):
        draw_line(self.char, self.x1,self.y1, self.x2,self.y2, self.output,self.baseColor,self.palette, drawNc)
        draw_line(self.char, self.x2,self.y2, self.x3,self.y3, self.output,self.baseColor,self.palette, drawNc)
        draw_line(self.char, self.x3,self.y3, self.x4,self.y4, self.output,self.baseColor,self.palette, drawNc)
        draw_line(self.char, self.x4,self.y4, self.x1,self.y1, self.output,self.baseColor,self.palette, drawNc)
...
class rectangle2():
    ...
    def draw(self,drawNc=False):
        ...
        p3 = [c2x,c2y]
        p4 = [c1x,c2y]
        draw_line(self.char,*p1,*p2, self.output,self.baseColor,self.palette, drawNc)
        draw_line(self.char,*p2,*p3, self.output,self.baseColor,self.palette, drawNc)
        draw_line(self.char,*p3,*p4, self.output,self.baseColor,self.palette, drawNc)
        draw_line(self.char,*p4,*p1, self.output,self.baseColor,self.palette, drawNc)
...
class circle():
    def __init__(self,char,xM,yM,r, output=object,baseColor=None,palette=DrawlibStdPalette, autoDraw=False,autoDrawNc=False):
        ...
        if autoDraw == True: self.draw(autoDrawNc)
    def draw(self,drawNc=False):
        draw_circle(self.char,self.xM,self.yM,self.r, self.output,self.baseColor,self.palette, drawNc)
...
class ellipse():
    def __init__(self,char,cX,cY,xRad,yRad, output=object,baseColor=None,palette=DrawlibStdPalette, autoDraw=False,autoDrawNc=False):
        ...
        if autoDraw == True: self.draw(autoDrawNc)
    def draw(self,drawNc=False):
        draw_ellipse(self.char,self.cX,self.cY,self.xRad,self.yRad, self.output,self.baseColor,self.palette, drawNc)
...
class quadBezier():
    def __init__(self,char,sX,sY,cX,cY,eX,eY, output=object,baseColor=None,palette=DrawlibStdPalette, autoDraw=False,autoDrawNc=False):
        ...
        if autoDraw == True: self.draw(autoDrawNc)
    def draw(self,drawNc=False):
        draw_quadBezier(self.char,self.sX,self.sY,self.cX,self.cY,self.eX,self.eY, self.output,self.baseColor,self.palette, drawNc)
...
class cubicBezier():
    def __init__(self,char,sX,sY,c1X,c1Y,c2X,c2Y,eX,eY,algorithm="step",modifier=None, output=object,baseColor=None,palette=DrawlibStdPalette, autoDraw=False,autoDrawNc=False):
        ...
        if autoDraw == True: self.draw(autoDrawNc)
    def draw(self,drawNc=False):
        draw_cubicBezier(self.char,self.sX,self.sY,self.c1X,self.c1Y,self.c2X,self.c2Y,self.eX,self.eY,self.algorithm,self.modifier, self.output,self.baseColor,self.palette, drawNc)
