...
class boxImage():
    def __init__(self,imagePath=str,mode="foreground",char=None,monochrome=False,width=None,height=None,resampling="lanczos",method=None,textureCodec=None,xPos=None,yPos=None,strTxtMethod=False,output=None,baseColor=None,palette=DrawlibStdPalette):
        # Req Arguments
        self.imagePath = imagePath
        # Presets
        self.rentype = "box"
